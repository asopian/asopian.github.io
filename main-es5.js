(function () {
  ...
  (self["webpackChunkpokemon_gallery"] = self["webpackChunkpokemon_gallery"] || []).push([["main"], {
    ...
    158: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _pokemons_pokemons_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./pokemons/pokemons.component */
      5386);
      /* harmony import */
      ...
      var routes = [{
        ...
        path: 'pokemons',
        component: _pokemons_pokemons_component__WEBPACK_IMPORTED_MODULE_0__.PokemonsComponent
      }];
    ...
    6747: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _pokemons_pokemons_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./pokemons/pokemons.component */
      5386);
      /* harmony import */
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵsetNgModuleScope"](_AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_1__.AppComponent, _header_header_component__WEBPACK_IMPORTED_MODULE_2__.HeaderComponent, _pokemons_pokemons_component__WEBPACK_IMPORTED_MODULE_3__.PokemonsComponent],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_5__.BrowserModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_6__.HttpClientModule, _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule]
        });
      })();
      /***/
    ...
    3482: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      _HeaderComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 4,
        vars: 1,
        consts: [[1, "header-container", "header-container-xs", "header-container-sm", "header-container-md", "header-container-lg", "header-container-xl"]],
    ...
    /***/
    4153: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PokemonService": function PokemonService() {
          return (
            /* binding */
            _PokemonService
          );
      ...
      var _pokemon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./pokemon */
      8029);
      /* harmony import */
      ...
      var _PokemonService = /*#__PURE__*/function () {
        ...
        function _PokemonService(http) {
          _classCallCheck(this, _PokemonService);

          this.http = http; // ---------- Remote URL
        ...
        _createClass(_PokemonService, [{
          key: "getPokemons",
          value: function getPokemons() {
            var convertToPokemonArray = (0, rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.map)(function (value) {
            ...
            return convertToPokemonArray(this.http.get(this.pokeapiUrl).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(this.handleError('getPokemons', []))));
          }
          /**
      ...
      _PokemonService.ɵfac = function PokemonService_Factory(t) {
        return new (t || _PokemonService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClient));
      };

      _PokemonService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
        token: _PokemonService,
        factory: _PokemonService.ɵfac,
        providedIn: 'root'
      });
      /***/
    },
    ...
    /***/
    8029: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      */
      function _Pokemon(url, name) {
        _classCallCheck(this, _Pokemon);
    ...
    /***/
    5386: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PokemonsComponent": function PokemonsComponent() {
          return (
            /* binding */
            _PokemonsComponent
          );
      ...
      var _pokemon_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ../pokemon.service */
      4153);
      /* harmony import */
      ...
      function PokemonsComponent_div_15_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _PokemonsComponent = /*#__PURE__*/function () {
        function _PokemonsComponent(pokemonService) {
          _classCallCheck(this, _PokemonsComponent);

          this.pokemonService = pokemonService;
          this.ITEMS_PER_PAGE = 20;
        }

        _createClass(_PokemonsComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.currentSearch = "";
            this.currentPage = 1;
          ...
          key: "updateFilteredPokemons",
          value: function updateFilteredPokemons() {
            var _this2 = this;

            this.pokemonsFiltered = this.pokemonsFull.filter(function (pokemon) {
              return pokemon.name.match(new RegExp(_this2.currentSearch, 'i'));
            });
            this.updateDisplayedPokemons();
          }
        }, {
          key: "updateDisplayedPokemons",
          value: function updateDisplayedPokemons() {
            this.totalPages = Math.ceil(this.pokemonsFiltered.length / this.ITEMS_PER_PAGE);
            if (this.currentPage < 1) this.currentPage = 1;
            if (this.currentPage > this.totalPages) this.currentPage = this.totalPages;
            this.pokemonsDisplayed = this.pokemonsFiltered.slice((this.currentPage - 1) * this.ITEMS_PER_PAGE).slice(0, this.ITEMS_PER_PAGE);
          }
        }, {
          key: "nextPage",
        ...
        return _PokemonsComponent;
      }();

      _PokemonsComponent.ɵfac = function PokemonsComponent_Factory(t) {
        return new (t || _PokemonsComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_pokemon_service__WEBPACK_IMPORTED_MODULE_0__.PokemonService));
      };

      _PokemonsComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: _PokemonsComponent,
        selectors: [["app-pokemons"]],
        decls: 16,
        vars: 3,
        consts: [[1, "container"], [1, "form-control", 2, "text-align", "center"], [1, "input-group"], [1, "input-group-prepend"], [1, "btn", "btn-primary", 3, "click"], ["placeholder", "Enter search term here...", 1, "form-control", 3, "keyup"], ["searchBox", ""], [1, "input-group-append"], [1, "row"], ["class", "col-12 col-md-6 col-xl-3", 4, "ngFor", "ngForOf"], [1, "col-12", "col-md-6", "col-xl-3"], [1, "row", "pokerow"], [1, "col-6", "col-md-12", "col-xl-12"], [3, "src"], [1, "col-12"]],
        template: function PokemonsComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PokemonsComponent_Template_button_click_5_listener() {
              return ctx.previousPage();
            });

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](6, " <<\xA0 Prev 20 ");
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("keyup", function PokemonsComponent_Template_input_keyup_7_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function PokemonsComponent_Template_button_click_10_listener() {
              return ctx.nextPage();
            });

            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](11, " Next 20 \xA0>> ");
